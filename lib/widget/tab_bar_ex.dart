...
class TabBarEx extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// and the entire [TabBarEx] is scrollable. Otherwise each tab gets an equal
  ...
  /// An optional callback that's called when the [TabBarEx] is tapped.
  ///
...
class _TabBarExState extends State<TabBarEx> {
  ...
  @override
  void didUpdateWidget(TabBarEx oldWidget) {
